...
def generate_launch_description():
    ...
    def _create_dynamic_bridge_node(context, *args, **kwargs):
        ...
        #################
        # NOTE: To resolve the names we use the /tmp{robot_name}_gz.sensors.yaml file generated by the description
        # command with the sensors output. In the file, sensor are assigned classes and subclasses (e.g. camera/realsense).
